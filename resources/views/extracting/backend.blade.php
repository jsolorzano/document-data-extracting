        ...
        function dataExtracting() {
            return {
                ...
                async handleFileUpload(target) {
                    ...
                    try {
                        // Llamamos a nuestra API de Laravel
                        const response = await fetch('/api/extract-document', {
                            method: 'POST',
                            body: formData,
                            headers: {
                                // Si usas web routes en vez de api, recuerda mandar el token CSRF:
